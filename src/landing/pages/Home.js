  ...
  return (
    <div style={{ backgroundColor: '#071215' }}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={1} md={5}>
          <Hidden smDown>
          {/* <Parallax bgImage={backgroundTrazado} strength={500}>
          <Box my={60}></Box>
          </Parallax> */}
          <Trazado />
          </Hidden>
      ...
      <Grid container direction="column">
        <Box my={34}>
          <Grid item xs={12} data-aos="zoom-out-up">
            <Phrases textWithoutColor='Start measuring and expanding self-wareness.' textWithColor='Feel your wisdom.' />
          </Grid>
        </Box>
      </Grid>
      ...
      <Box my={14}>
          <Grid item xs={12} data-aos="zoom-out-up">
            <Grid
              ...
              <Grid container xs={12} direction='row' style={{ alignItems: 'center' }}>
              </Grid>
            </Grid>
        </Box>
      </Grid>
...
{/* BLOQUE 7 Citation */}
      <Parallax bgImage={backgroundSelfAwareness} strength={500}>
      ...
      <Box my={34}>
          <Grid item xs={12} data-aos="zoom-out-up">
            <Phrases textWithoutColor='The world 1st self-awareness assesment' textWithColor='and coach is here for you and your team.' />
          </Grid>
        </Box>
      </Grid>
      </Parallax>
